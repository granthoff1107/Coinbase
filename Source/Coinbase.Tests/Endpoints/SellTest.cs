...
namespace Coinbase.Tests.Endpoints
{
   public class SellTests : OAuthServerTest
   {
      ...
      public async Task can_list()
      {
         ...
         var r = await client.Accounts.ChildOf("fff").Sells.GetListAsync();
      ...
      public async Task can_get()
      {
         ...
         var r = await client.Accounts.ChildOf("fff").Sells.GetAsync("uuu");
      ...
      public async Task can_place_buyorder()
      {
         ...
         var r = await client.Accounts.ChildOf("fff").Sells.CreateAsync(create );
      ...
      public async Task can_commit()
      {
         ...
         var r = await client.Accounts.ChildOf("fff").Sells.CommitAsync("uuu");
